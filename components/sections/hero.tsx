  ...
  return (
    ...
    >
      ...
      <div className="relative z-30 flex flex-col items-center pt-[12vh]">
        <h1
          ref={headlineRef}
          className="w-full max-w-md text-center font-display text-display-sm uppercase leading-snug text-white md:w-[80vw] md:max-w-none md:text-display-lg"
        >
      ...
      >
        <h2 className="w-full max-w-lg text-center font-display text-display-sm uppercase leading-tight text-white md:max-w-4xl md:text-display-md">
